...
def _build_config(provider: str, default_model: str, embedding_model: str, embedding_dim: int, embedding_url: str, mode: str, telegram_token: str, mcp_servers: list) -> dict:
    return {
        ...
        "providers": {
            ...
            "openrouter": {"base_url": "https://openrouter.ai/api/v1", "models": [{"name": "anthropic/claude-sonnet-4", "default": True}, {"name": "openai/gpt-4o"}], "extra_headers": {"HTTP-Referer": "https://jalaagent.dev", "X-Title": "JalaAgent"}},
